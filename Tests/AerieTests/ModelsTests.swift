...
final class ModelsTests: XCTestCase {
    ...
    func test_claudeModel_rawValuesAndDisplayNames() {
        ...
        XCTAssertEqual(ClaudeModel.opus55.rawValue, "claude-opus-5-5")
        ...
        XCTAssertEqual(ClaudeModel.opus55.displayName, "Opus 5.5")
    ...
    func test_claudeModel_allCases_hasExactlyFourInOrder() {
        XCTAssertEqual(ClaudeModel.allCases, [.sonnet5, .opus55, .haiku45, .fable51])
    }
    ...
    func test_claudeModel_resolve_carriesRetiredModelsToTheirSuccessor() {
        XCTAssertEqual(ClaudeModel.resolve(stored: "claude-opus-5"), .opus55)
        XCTAssertEqual(ClaudeModel.resolve(stored: "claude-opus-4-8"), .opus55)
